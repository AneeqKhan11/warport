    ...
    return (
        <ScrollView>
            ...
            <View style={styles.paragraph}>
                <Text style={{ textAlign: "center", fontSize: 16, fontWeight: "bold" }}>Select Your Market Place</Text>
            </View>
            ...
            <View style={styles.continueButton}>
                ...
                >
                    <Text style={{ textAlign: "center", color: "white", fontSize: 16 }}>Continue</Text>
                </TouchableOpacity>
                {/* <Button
