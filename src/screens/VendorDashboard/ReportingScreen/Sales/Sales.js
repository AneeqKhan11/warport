  ...
  return (
    <ScrollView style={styles.scrollViewMain}>
      ...
      <TouchableOpacity
        ...
        <Text style={{ fontSize: 17, color: 'white' }}>{translation("Add New Record")}</Text>
      </TouchableOpacity>
      <Divider ></Divider>
...
`
  ...
  return (<>
    <View style={{
      ...
      <View style={{ height: '100%', width: '100%', justifyContent: 'center', alignItems: 'center' }}><Text style={{ fontSize: 20, fontWeight: "bold", color: '#402798', marginLeft: -20 }}>Add New Record</Text></View>
    </View>
    <Divider ></Divider>
