  ...
  useEffect(() => {
    ...
    return(
        ...
        <View style={{ flex: 1, backgroundColor:'white', alignItems:'center', marginVertical:"1%" }}>
              <Text style={{fontSize:30,marginLeft:-10, borderColor:'blue', borderRadius:5, backgroundColor:'blue', color:'white', paddingHorizontal:10, marginVertical:5}}>Purchase Orders</Text>
        </View>
      ...
      <View style={styles.poLifeCycleText}>
        <Text>{translation("PO LIFE CYCLE")}</Text>
      </View>
